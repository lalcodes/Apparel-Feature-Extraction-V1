...
from augment import get_anchor_gt
from vgg import get_img_output_length, nn_base, rpn_layer, classifier_layer
from loss import *
...
base_path = '/content/Syam-Frcnn'

train_path = '/content/Syam-Frcnn/keras_frcnn/dataset/annotation.txt'
